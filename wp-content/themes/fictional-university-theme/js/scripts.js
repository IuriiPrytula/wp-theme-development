  ...
  function () {
    ...
    _createClass(MyNotes, [{
      ...
      value: function deleteNote(e) {
        var theNote = $(e.target).parents('li');
        $.ajax({
          beforeSend: function beforeSend(xhr) {
            xhr.setRequestHeader('X-WP-Nonce', universiytData.nonce);
          },
          url: "".concat(window.location.origin, "/wp-json/wp/v2/note/").concat(theNote.data('id')),
          type: 'DELETE',
      ...
      value: function updateNote(e) {
        ...
        $.ajax({
          ...
          data: updatetNote,
          success: function success(response) {
            _this.makeNoteReadOnly(theNote);
          },
          error: function error(response) {
            console.log('error');
            console.log(response);
      ...
      value: function createNote(e) {
        ...
        $.ajax({
          ...
          url: "".concat(window.location.origin, "/wp-json/wp/v2/note/"),
          type: 'POST',
          data: newNote,
          success: function success(response) {
            console.log(response);
      ...
      value: function makeNoteEditable(theNote) {
      ...
      value: function makeNoteReadOnly(theNote) {
        theNote.find('.edit-note').html('<i class="fa fa-pencil" aria-hidden="true"></i> Edit');
        theNote.find('.note-title-field, .note-body-field').attr('readonly', 'readonly').removeClass('note-active-field').removeAttr('data-state');
        theNote.find('.update-note').addClass('update-note--visible');
  ...
  function () {
    ...
    _createClass(Search, [{
      ...
      value: function getResults() {
        ...
        $.getJSON(window.location.origin + '/wp-json/university/v1/search?term=' + this.searchField.val(), function (result) {
          var generalInfo = [];
          generalInfo = generalInfo.concat(result.posts, result.pages);

          _this2.resultsDiv.html("\n          <div class=\"row\">\n          <div class=\"one-third\">\n            <h2 class=\"search-overlay__section-title\">General Information</h2>\n            ".concat(generalInfo.length ? '<ul class="link-list min-list">' : '<p>No information matched the search</p>', "\n            ").concat(generalInfo.map(function (item) {
            return "<li><a href=\"".concat(item.url, "\">").concat(item.title, "</a></li>");
          }).join(''), "\n            ").concat(generalInfo.length ? '</ul>' : '', "\n          </div>\n          <div class=\"one-third\">\n            <h2 class=\"search-overlay__section-title\">Programs</h2>\n            ").concat(result.programs.length ? '<ul class="link-list min-list">' : '<p>No information matched the search</p>', "\n            ").concat(result.programs.map(function (item) {
            return "<li><a href=\"".concat(item.url, "\">").concat(item.title, "</a></li>");
          }).join(''), "\n            ").concat(result.programs.length ? '</ul>' : '', "\n            <h2 class=\"search-overlay__section-title\">Professors</h2>\n            ").concat(result.professors.length ? '<ul class="professor-cards">' : '<p>No information matched the search</p>', "\n            ").concat(result.professors.map(function (item) {
          ...
          }).join(''), "\n            ").concat(result.professors.length ? '</ul>' : '', "\n          </div>\n          <div class=\"one-third\">\n            <h2 class=\"search-overlay__section-title\">Campuses</h2>\n            ").concat(result.campuses.length ? '<ul class="link-list min-list">' : '<p>No information matched the search</p>', "\n            ").concat(result.campuses.map(function (item) {
            return "<li><a href=\"".concat(item.url, "\">").concat(item.title, "</a></li>");
          }).join(''), "\n            ").concat(result.campuses.length ? '</ul>' : '', "\n            <h2 class=\"search-overlay__section-title\">Events</h2>\n            ").concat(result.events.map(function (item) {
            return "\n              <div class=\"event-summary\">\n              <a class=\"event-summary__date t-center\" href=\"".concat(item.link, "\">\n                <span class=\"event-summary__month\">").concat(item.date.month, "</span>\n                <span class=\"event-summary__day\">").concat(item.date.day, "</span>\n              </a>\n              <div class=\"event-summary__content\">\n                <h5 class=\"event-summary__title headline headline--tiny\"><a href=\"").concat(item.link, "\">Poetry Day</a></h5>\n                <p>").concat(item.excerpt, "</p>\n              </div>\n              </div>\n            ");
          }).join(''), "\n          </div>\n        </div>\n        "));
