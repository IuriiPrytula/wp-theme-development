      ...
      <div class="site-header__menu group">
        ...
        <div class="site-header__util">
          <?php if (is_user_logged_in()) { ?>
            <a href="<?php echo esc_url(site_url('/my-notes')) ?>" class="btn btn--orange btn--small float-left push-right">
              My Notes
            </a>
            <a href="<?php echo wp_logout_url(); ?>" class="btn btn--dark-orange btn--small btn--with-photo float-left">
